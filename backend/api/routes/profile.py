...
async def get_my_profile(
    ...
    """
    try:
        profile = await profile_service.get_current_user_profile(
...
@router.get(
    ...
    description="Get a user's profile. Returns full profile if viewing own, public profile otherwise.",
)
...
async def upload_profile_picture(
    ...
    try:
        ...
        await profile_service.update_profile(
            user_id=user_id,
            update_data=ProfileUpdate(profile_picture_url=public_url)
        )
